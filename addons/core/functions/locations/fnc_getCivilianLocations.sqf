            ...
            if (_excluded) then {
                ...
                if (_isSpecial) then {
                    ...
                    if (_isLandmark) then {
                        ...
                        private _nearbyMaritime = nearestObjects [_pos, _maritimeStructures, 100];
                        ...
                        if (_nearbyMaritime isNotEqualTo []) then {
                            ...
                            private _nearbyBuildings = nearestTerrainObjects [_pos, ["BUILDING", "HOUSE", "VILLAGE", "CITY"], 300];
