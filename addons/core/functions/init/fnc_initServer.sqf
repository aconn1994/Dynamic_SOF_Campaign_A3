...
// ============================================================================
// Dynamic Simulation: enable system + per-category activation distances.
// Presence-spawned groups opt in via `enableDynamicSimulation true` in each
// setup function. Civilians use a coef to shorten their effective distance
// (~825m at the populatedArea band) so cities 1km+ away don't run AI.
// ============================================================================
