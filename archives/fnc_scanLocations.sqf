...
private _clusterRadius = _config getOrDefault ["clusterRadius", 25];
...
// ============================================================================
systemChat format ["DSC - %1 - Gathering all structures...", call _getTimeAsString];
...
systemChat format ["DSC - %1 - All structures gathered.", call _getTimeAsString];
// ============================================================================
// STAGE 2: Spatial Clustering (using nearObjects for performance)
// ============================================================================
systemChat format ["DSC - %1 - Initializing spatial clustering...", call _getTimeAsString];
...
systemChat format ["DSC - %1 - Spatial clustering done.", call _getTimeAsString];
// ============================================================================
// STAGE 3: Feature Extraction + Tagging
// ============================================================================
systemChat format ["DSC - %1 - Tagging locations...", call _getTimeAsString];
private _locations = [];
...
systemChat format ["DSC - %1 - Locations Tagged.", call _getTimeAsString];
// ============================================================================
...
if (_debug) then {
...

    {
        ...
        if ("civilian" in _tags && "isolated" in _tags) then { continue };
